    ...
    return (
        <>
            <section className='py-12 container max-w-7xl mx-auto px-4 '>
                <h2 className='text-3xl font-bold mb-12 text-center pt-4'>Featured Projects</h2>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                    {
                        projects.map((project) => (
                            <article key={project.title} className='bg-white dark:bg-dark/50 rounded-lg shadow-md p-6'>
                               ...
                               {/* _blank means another page */}
                                <div className='flex gap-4 mt-2'>
                                    <Link href={project.githubLink} target="_blank" className="flex item-center gap-2 text-secondary hover:text-primary transition-colors">
                                    <FaGithub className='w-5 h-5'/><span>Source Code</span>
                                   </Link>
                                   <Link href={project.demoLink} target="_blank" className="flex item-center gap-2 text-secondary hover:text-primary transition-colors">
